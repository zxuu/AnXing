...
import com.mingrisoft.anxingdemo3.UI.baidu.MyRecognizer;
import com.mingrisoft.anxingdemo3.UI.recognization.CommonRecogParams;
import com.mingrisoft.anxingdemo3.UI.recognization.IStatus;
import com.mingrisoft.anxingdemo3.UI.recognization.MessageStatusRecogListener;
import com.mingrisoft.anxingdemo3.UI.recognization.OfflineRecogParams;
import com.mingrisoft.anxingdemo3.UI.recognization.StatusRecogListener;
import com.mingrisoft.anxingdemo3.UI.util.AutoCheck;
...
public abstract class ActivityRecog extends ActivityCommon implements IStatus {
    ...
    String textReault;
    public static final int STARTSERVICE = 90;
    ...
    protected void handleMsg(Message msg) {
        ...
        switch (msg.what) { // 处理MessageStatusRecogListener中的状态回调
            case STATUS_FINISHED:
                if (msg.arg2 == 1) {
                    textReault = msg.obj.toString();
                    txtResult.setText(textReault);
                    if (textReault.contains("我要报警了") ||
                            textReault.contains("你想干嘛") ||
                            textReault.contains("别碰我")) {
//                        Toast.makeText(this, "发送求救信号！", Toast.LENGTH_SHORT).show();
                        cancel();
                        status = STATUS_NONE;
                        startActivity(new Intent(this,VoiceMonitorActivity.class));
                    }
                }
                status = msg.what;
                updateBtnTextByStatus();
